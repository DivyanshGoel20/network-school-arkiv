    ...
    <div className="min-h-screen bg-[#0d0e12] text-zinc-100 flex flex-col font-sans select-none overflow-x-hidden pb-12">
      ...
      <header className="relative border-b border-zinc-800 bg-[#121318] px-6 py-4 flex items-center justify-between z-20 shadow-md">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-zinc-800 border border-zinc-700 rounded-lg text-amber-500">
            <Sparkles className="w-5 h-5" />
          </div>
          <div>
            <h1 className="text-sm font-black font-mono tracking-widest uppercase text-zinc-100">
              CASEBOOK • Arkiv Cluedo
            </h1>
            <p className="text-[9px] font-mono text-zinc-500 tracking-widest uppercase mt-0.5">
              Decentralized Cryptographic AI Detective Game • Braga Testnet
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 text-xs font-mono">
          ...
          <div className="flex items-center gap-2 border-r border-zinc-800 pr-4 mr-2">
            <button
              ...
              className={`py-1.5 px-3 rounded-lg font-bold font-mono text-[9px] uppercase tracking-widest flex items-center justify-center gap-1.5 border transition-all duration-200 ${
                isPlaying
          ...
          <div className="relative overflow-hidden p-5 bg-[#171410] border border-amber-500/20 rounded-2xl shadow-lg backdrop-blur-md animate-in fade-in slide-in-from-top-4 duration-300">
            <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6 z-10">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-3 flex-wrap">
                    <div className="flex items-center justify-between gap-3 px-3.5 py-1.5 bg-zinc-950 border border-zinc-800 rounded-lg text-[9px] font-mono font-bold text-zinc-300 shadow-inner">
              ...
              <div className="flex flex-col items-end shrink-0 justify-center">
                ...
                <div className="max-w-[280px] bg-zinc-950 border border-zinc-900 px-3 py-2.5 rounded-xl text-[9px] font-mono text-red-400 max-h-16 overflow-y-auto mt-1 break-words shadow-inner leading-normal">
                  {transactionError}
                </div>
              </div>
            </div>
            ...
            <div className="manila-dossier p-4 flex flex-col md:flex-row items-center justify-between gap-4 border-2 shadow-lg w-full">
              ...
              <div className="flex items-center gap-3 w-full md:w-auto">
                ...
                <div className="flex flex-col leading-tight font-typewriter">
                  <span className="text-[10px] font-black text-[#1c1d22] uppercase tracking-widest">
                    TAMPER-PROOF CASE FILE
                  </span>
                  <span className="text-[8px] text-[#1c1d22]/60 uppercase tracking-tight">
              ...
              <div className="flex-1 w-full md:w-auto font-typewriter">
                {status === "finished" && envelope ? (
                  <div className="p-2 bg-emerald-100/50 border border-dashed border-emerald-800/40 rounded-lg text-center flex flex-col items-center justify-center gap-0.5">
                    <span className="text-[8px] text-emerald-800 uppercase tracking-widest font-black">
                      CASE SUCCESSFULLY SOLVED!
                    </span>
                    <div className="flex flex-wrap justify-center gap-3 text-[10px] font-black text-zinc-900 uppercase mt-1">
                  ...
                  <div className="flex items-center gap-3 bg-[#1c1d22]/5 border border-[#1c1d22]/15 px-3 py-1.5 rounded-lg justify-between shadow-inner">
                    <span className="text-[8px] text-[#1c1d22]/60 uppercase tracking-wider font-black whitespace-nowrap">
                      ON-CHAIN COMMITMENT:
                    </span>
                    <div className="text-[8.5px] text-[#1c1d22] break-all select-all font-typewriter leading-normal max-w-none">
                      {encryptedEnvelope}
                    </div>
                    <span className="text-[7.5px] text-[#1c1d22]/40 italic shrink-0 hidden lg:inline">
                      (Committed on Braga)
                    </span>
                  </div>
                )}
              ...
              <div className="flex items-center gap-3 w-full md:w-auto justify-end shrink-0">
                <span className={`px-2 py-0.5 text-[8px] font-bold font-typewriter rounded-md border-2 uppercase ${
                  status === "finished" 
                ...
                {sessionTxHash && (
                  <a
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1 bg-[#1c1d22]/10 border border-[#1c1d22]/20 hover:border-amber-900/65 hover:bg-amber-900/10 text-amber-900 text-[8px] font-bold font-mono rounded-md uppercase tracking-wider transition-all duration-200"
                  >
